...
### **Continue Building**
- **[LLM Applications](llm.qmd)** - Apply these patterns to LLM workflows
- **[Basic Python Tracing](../tutorials/basic.qmd)** - Learn simpler approaches first

### **Learn More**
- **[OpenTelemetry GenAI Conventions](https://opentelemetry.io/docs/specs/semconv/gen-ai/){target="_blank"}** - Full specification
- **[LangFuse Python SDK](python-sdk.qmd)** - Alternative SDK-based approach

---

*OpenTelemetry provides the most comprehensive and standards-based approach to AI observability. Use it for production applications where interoperability and rich context are important.* 