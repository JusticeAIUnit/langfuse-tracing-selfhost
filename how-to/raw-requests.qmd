---
title: "Tracing With The `requests` Library"
format:
  html:
    toc: true
diataxis:
...
- **[Basic Python Tracing](../tutorials/basic.qmd)** - Return to using the SDK
- **[LLM Applications](llm.qmd)** - Apply tracing to your AI applications

### **If Issues Persist**
- **[Troubleshooting Guide](troubleshooting.qmd)** - More debugging techniques
- **[Environment Configuration](config.qmd)** - Verify your setup
