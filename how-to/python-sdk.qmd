---
title: "Tracing With The `langfuse` Python Library"
format:
  html:
    toc: true
diataxis:
...
### **Continue Building**
- **[LLM Applications](llm.qmd)** - Apply SDK tracing to AI applications
- **[Basic Python Tracing](../tutorials/basic.qmd)** - Learn more SDK patterns

### **If You Need Raw Control**
- **[Raw HTTP Requests](raw-requests.qmd)** - Debug with direct API calls

---

*The LangFuse Python SDK provides the best balance of control and convenience for production applications. Use it for reliable, maintainable tracing implementations.* 