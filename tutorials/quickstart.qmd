...
- **[Basic Python Tracing](basic.qmd)** - Learn more patterns and techniques

### **Solve Specific Problems (How-to Guides)**
- **[LLM Application Tracing](../how-to/llm.qmd)** - Add tracing to AI applications
- **[Complex Workflow Monitoring](../how-to/workflow.qmd)** - Trace multi-step processes

### **Get Help**
- **Examples**: Check out our [comprehensive Python examples](basic.qmd)
- **LLM Integration**: See [LLM-specific patterns](../how-to/llm.qmd)
