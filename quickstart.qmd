...
- **[Basic Python Tracing](examples/basic.qmd)** - Learn more patterns and techniques

### **Solve Specific Problems (How-to Guides)**
- **[LLM Application Tracing](examples/llm.qmd)** - Add tracing to AI applications
- **[Complex Workflow Monitoring](examples/workflow.qmd)** - Trace multi-step processes
