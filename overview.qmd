...
1. **[Quick Start Guide](quickstart.qmd)** - Get running in 5 minutes
2. **[Basic Python Tracing](examples/basic.qmd)** - Core instrumentation patterns
3. **[LLM Examples](examples/llm.qmd)** - OpenAI, LangChain, and RAG implementations
